...
fn print_help() {
    ...
    println!();
    println!("SUBCOMMANDS:");
    println!("    route-case-from-registry  Route a case using a manufacturer registry snapshot");
    println!("    route-case                Route a case with pre-computed candidates and snapshots");
    ...
    println!();
    println!("OPTIONS (route-case-from-registry):");
    println!("    --case <path>         Path to case JSON file");
    println!("    --registry <path>     Path to manufacturer registry snapshot JSON file");
    println!("    --config <path>       Path to routing config JSON file");
    ...
    println!("    --policy <path>       Path to the policy JSON file (derived_policy.json)");
